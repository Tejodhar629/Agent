...
const consultation_resolver_1 = require("./consultation.resolver");
...
exports.ConsultationModule = ConsultationModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [consultation_service_1.ConsultationService, consultation_resolver_1.ConsultationResolver],
